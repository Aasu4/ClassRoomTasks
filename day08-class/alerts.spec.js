...
(0, test_1.test)("Handle Promot Alers", function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var page = _b.page;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                //Handle Prompt Alert
                page.on('dialog', function (alertType) {
                    // type of alert
            ...
            case 1:
                //Login to URL
                _c.sent();
                return [4 /*yield*/, page.locator("//span[text()='Show']").nth(4).click()
